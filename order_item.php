            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    ...
                    <form action="proses/proses_delete_menu.php" method="POST" class="p-4 md:p-5">
                     ...
                     <button data-modal-hide="popup-modal-<?= $row['id_list_order']; ?>" name="delete_order_validate" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Hapus
                     </button>
